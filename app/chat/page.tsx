          ...
          {messages.length === 0 && (
            <div className="text-center py-16">
              ...
              {collections.length === 0 ? (
                ...
                <>
                  <p className="text-sm text-text-muted max-w-sm mx-auto">
                    Select a collection above, or leave on{' '}
                    <span className="text-text-primary">All collections</span> to search across everything.
                    Answers include citations to the source passages.
                  </p>
