...
import { AlertCircle, BrainCircuit, Loader2, Lock, Mail, UserRound } from 'lucide-react';
      ...
      <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[1fr_420px] lg:items-center">
        <section>
          ...
          <p className="mt-5 max-w-xl text-text-secondary">
            Create an account, upload documents, and keep every collection isolated to your login. No shared demo user,
            no fake workspace environment variables.
          </p>
